//
//  AffirmSiteModalViewController.m
//  AffirmSDK
//
...
#import "AffirmSiteModalViewController+Protected.h"
#import "AffirmConfiguration+Protected.h"
#import "AffirmCheckoutData.h"
#import "AffirmUtils.h"

@implementation AffirmSiteModalViewController
...
+ (instancetype)siteModalControllerWithModalId:(NSString *)modalId {
    ...
    NSString *filePath = [sdkBundle pathForResource:@"site_modal_template" ofType:@"html"];
    NSString *rawContent = [NSString stringWithContentsOfFile:filePath encoding:NSUTF8StringEncoding error:nil];
    NSString *content = [NSString stringWithFormat:rawContent, modalId, configuration.publicAPIKey, configuration.affirmJavascriptURL.absoluteString, AFFIRM_CHECKOUT_CANCELLATION_URL];
