...
- (void)configureWithAmount:(NSDecimalNumber *)amount
    ...
    [AffirmAsLowAs getAffirmAsLowAsForAmount:amount promoId:self.promoID affirmLogoType:affirmLogoType affirmColor:affirmColor callback:^(NSString *ala, UIImage *logo, BOOL showPrequal, NSError *error, BOOL success) {
